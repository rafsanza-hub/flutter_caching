...
extension ProductCollectionByIndex on IsarCollection<ProductCollection> {
  Future<ProductCollection?> getById(int id) {
    return getByIndex(r'id', [id]);
  }

  ProductCollection? getByIdSync(int id) {
  ...
  Future<List<ProductCollection?>> getAllById(List<int> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<ProductCollection?> getAllByIdSync(List<int> idValues) {
    final values = idValues.map((e) => [e]).toList();
...
extension ProductCollectionQueryWhereDistinct
  ...
  QueryBuilder<ProductCollection, ProductCollection, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductCollectionQueryProperty
  ...
  QueryBuilder<ProductCollection, String, QQueryOperations> dueDateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductCollection, String, QQueryOperations> priorityProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'priority');
    });
  }

  QueryBuilder<ProductCollection, String, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'status');
    });
  }

  QueryBuilder<ProductCollection, List<String>, QQueryOperations>
      tagsProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductCollection, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
